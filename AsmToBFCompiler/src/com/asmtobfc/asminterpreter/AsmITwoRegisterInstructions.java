...
public abstract class AsmITwoRegisterInstructions extends AsmIInstruction  {
	...
	public AsmITwoRegisterInstructions(AsmIRegister registerA, AsmIRegister registerB) {
	...
	public String toString() {
		...
		return getInstructionName() + " " + regAStr + " " + regBStr;
