...
public abstract class AsmIOneRegisterInstructions  extends AsmIInstruction  {
	AsmIRegister registerA;

	int regADefine = -1;

	public AsmIOneRegisterInstructions(AsmIRegister registerA) {
	...
	public String toString() {
		...
		return getInstructionName() + " " + regAStr;
	}
