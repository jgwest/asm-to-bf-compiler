...
public class IGT extends IConcreteInstruction {
	private ItrAddress left = null;
	private ItrAddress right = null;
	private IInstruction inner = null;
	
	
	public IGT(ItrAddress left, ItrAddress right, IInstruction inner) {
		this.left = left;
		this.right = right;
		this.inner = inner;
	}
	...
	public IInstruction decompose(CompilerStatus cs) {
		...
		ic.addInstruction(new ISet(t4, IDGtle.A_GREATERTHAN_B));
