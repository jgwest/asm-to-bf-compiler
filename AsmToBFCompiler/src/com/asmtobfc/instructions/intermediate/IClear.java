...
public class IClear extends IConcreteInstruction {
	ItrAddress dest = null;
	
	public IClear() { dest = null; }
	public IClear(ItrAddress a) { 
		dest = a;
	}
	...
	public IInstruction decompose(CompilerStatus cs) {
		...
		if(dest != null) {
			...
			return f.createInstruction(new IBF("[-]"));
		}
	}
