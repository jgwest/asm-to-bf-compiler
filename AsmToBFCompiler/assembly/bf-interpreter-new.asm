...
load r_TOP LABEL_TOP_LIMIT
load r_BOTTOM LABEL_BOTTOM_LIMIT
...
label LABEL_TOP_LIMIT
127

label LABEL_BOTTOM_LIMIT
-129
...
label mainloopinner3
		...
		JumpLte r_c r_TOP mainloopinner3store
		JumpLte r0 r0  mainloopinner3subtract

label mainloopinner3subtract
//		PrintStmnt "Overflow top"
		Sub r_c r_c r_TOP
		Sub r_c r_c r_TOP
		Sub r_c r_c r_ONE
		Sub r_c r_c r_ONE
		JumpLte r0 r0  mainloopinner3store

label mainloopinner3store
		Load r_z LABEL_MEM_START
		Add r_z r_z r_currMemPos
		StoreI r_z r_c
...
label mainloop5a
	...
	label mainloopinner5
		...
		LoadI r_c r_z
		Sub r_c r_c r_ONE
		JumpLte r_c r_BOTTOM mainloopinner5add
		JumpLte r0 r0 mainloopinner5store

	label mainloopinner5add
//		PrintStmnt "Overflow bottom"
		Add r_c r_c r_TOP
		Add r_c r_c r_TOP
		Add r_c r_c r_ONE
		Add r_c r_c r_ONE
